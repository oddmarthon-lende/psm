...
namespace PSMViewer.Editors
{
    ...
    public class StoreOptionEditor : ComboBoxEditor
    {
        ...
        /// <summary>
        /// Gets the <see cref="PSMonitor.Stores.Properties"/> instance from the current store.
        /// </summary>
        private static PSMonitor.Stores.Properties Properties
        {
            get
            {
                return PSMonitor.PSM.Store(Dispatcher.CurrentDispatcher).Options.Get();
            }
        } 
