...
namespace PSM.Viewer.Dialogs
{
    ...
    /// </summary>
    public class PropertiesWindow : Theme.Window
    {
        ...
        private ImageSource _icon = BitmapFrame.Create(Assembly.GetExecutingAssembly().GetManifestResourceStream("PSM.Viewer.Icons.application_form_edit.png"));
